# Generated by Django 5.2 on 2026-05-31 06:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volumeHoraire",
                    models.PositiveIntegerField(verbose_name="volume horaire"),
                ),
            ],
            options={
                "verbose_name": "cours",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="emploisDuTempsCrees",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="creneaux",
                to="emploi_du_temps.emploidutemps",
                verbose_name="emploi du temps",
            ),
        ),
        migrations.AddField(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("site", "nom"), name="salle_unique_par_site"
                    )
                ],
            },
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("heureDebut__lt", models.F("heureFin"))),
